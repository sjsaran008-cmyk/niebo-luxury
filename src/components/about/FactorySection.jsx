    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-20 px-6 lg:grid-cols-2">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -right-6 -top-6 h-full w-full rounded-[32px] border border-[#C8A96A]/20" />
          ...
          <div className="absolute bottom-8 left-8 rounded-2xl bg-black/85 px-8 py-5 backdrop-blur-md">
        ...
        >
          ...
          <div className="mt-14 border-l-2 border-[#C8A96A] pl-6">
            ...
            <p className="font-display text-2xl font-light italic leading-relaxed text-[#111]">
